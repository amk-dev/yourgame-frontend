<template>
	<documentation>
		...
		<p>
			...
			<a href="https://yourgame.live">https://yourgame.live</a> and any
			related services provided by Yourgame.
		</p>
		<p>
			By accessing
			<a href="https://yourgame.live">https://yourgame.live</a>, you agree
			...
			using any other services provided by Yourgame.
		</p>
		<p>
			We, Yourgame, reserve the right to review and amend any of these
		...
		<ol>
			...
			<li>
				...
				networks or any other service Yourgame provides;
			</li>
			<li>
		...
		<p>
			...
			are owned by or licensed to Yourgame and are protected by applicable
		...
		<p>
			...
			Yourgame at any time.
		</p>
		<h3>Liability</h3>
		<p>
			Our website and the materials on our website are provided on an 'as
			is' basis. To the extent permitted by law, Yourgame makes no
		...
		<p>
			In no event shall Yourgame or its suppliers be liable for any
			...
			materials on this website, even if Yourgame or an authorized
		...
		<p>
			...
			for general information purposes only. Yourgame does not warrant or
		...
		<h3>Links</h3>
		<p>
			Yourgame has not reviewed all of the sites linked to its website and
			is not responsible for the contents of any such linked site. The
			inclusion of any link does not imply endorsement, approval, or
			control by Yourgame of the site. Use of any such linked site is at
